...
namespace antiGGGravity.Commands.Rebar
{
    ...
    public class AssignElementNameCommand : BaseCommand
    {
        ...
        /// directly to each element's "Element Name" without any numbering.
        /// </summary>
            ...
            BuiltInCategory[] categories)
        {
            ...
            using (Transaction t = new Transaction(doc, "Assign Element Name (Copy Exact)"))
            {
                t.Start();
